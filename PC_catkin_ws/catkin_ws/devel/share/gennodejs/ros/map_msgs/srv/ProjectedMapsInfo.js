...
class ProjectedMapsInfoRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ProjectedMapsInfoRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ProjectedMapsInfoRequest(null);
...
class ProjectedMapsInfoResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ProjectedMapsInfoResponse(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ProjectedMapsInfoResponse(null);
    return resolved;
    }
};
...
module.exports = {
  ...
  datatype() { return 'map_msgs/ProjectedMapsInfo'; }
};
